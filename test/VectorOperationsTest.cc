...
// TODO: Flux dot product should be integral of velocities: weight by dx^2
...
// TODO: Test < q, curl(gamma) > = < curl( q ), gamma > if gamma zero on bndry

// TODO: Test < gamma, u x v > = < v, gamma x u >
